...
console.log(`character pada index 5 = ${dataChar}`) // tidak ada karakternya
...
console.log(namaLengkap.indexOf('f'))
...
//6. replace
namaLengkap = namaLengkap.replace('aydin nih bozz','ali chuross')
console.log(namaLengkap)
